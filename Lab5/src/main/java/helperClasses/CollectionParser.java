...
public class CollectionParser {
    ...
    private boolean anyExceptionsWithFile = false;
     ...
     * @return Hashtable<Integer, City> unmarshalledCollection
     */
    public Hashtable<Integer, City> unmarshalFromXml() { //подправить. Если не тот тип данных в xml файле, то записывает null
        ...
        try {
            ...
            while ((e = xmlEventReader.peek()) != null) {
                if (e.isStartElement() && ((StartElement) e).getName().equals(qNameKey)) {
                    ...
                    addElementIfItIsOk(collection, key, unmarshalledCity);
                } else {
                    xmlEventReader.next();
                }
            }
            ...
            System.out.print("Collection was not loaded: ");
            System.out.println("XML syntax error");
            anyExceptionsWithFile = true;
        } catch (IOException e) {
     ...
     */
    public boolean getAnyExceptionsWithFile() {
        return anyExceptionsWithFile;
    }
