 ...
 */
public class HelpCommand extends CommandWithoutArg {
    ...
    /** Execute method: displays commands description*/
    @Override
    public void execute() {
        System.out.println(output);
    }
    /** Private method which sets output. Used only in constructor*/
    private void setOutput(){
        ...
        stringBuilder.append("save - сохранить коллекцию в файл").append("\n");
    ...
    /** Method which gets output
     * @return String output
     */
    public String getOutput() {
        return output;
    }
    /** Overridden toString() method to convert an instance of the HelpCommand class into a string representation*/
    @Override
